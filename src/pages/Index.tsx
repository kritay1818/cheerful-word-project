      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-slate-700 mb-6 leading-tight">
            תפסיקו לפספס הזדמנויות תיווך בפייסבוק,
            <br />
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            המערכת החכמה שמנתחת פוסטים בקבוצות פייסבוק, מוצאת לקוחות ופוסטים פוטנציאליים שמתאימים בדיוק לעסק שלך, 
            ומספקת לך רשימה מסודרת של הזדמנויות תיווך איכותיות
          </p>
